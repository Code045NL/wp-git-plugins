                    ...
                    <tr class="repo-row" data-repo="<?php echo esc_attr($repo['url']); ?>">
                        <td>
                            ...
                            <div style="margin-top:8px;">
                                <select class="branch-select" data-repo-url="<?php echo esc_attr($repo['url']); ?>" data-current-branch="<?php echo esc_attr($repo['branch'] ?? 'main'); ?>" style="min-width:120px; margin-left:8px;">
                                    <option value="<?php echo esc_attr($repo['branch'] ?? 'main'); ?>">Loading...</option>
                                </select>
                            </div>
                        </td>
                        <td>
